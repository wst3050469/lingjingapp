...
export function registerSshIpc(mainWindow: BrowserWindow): void {
  ...
  // NOTE: window-independent handlers (ssh:list-connections, ssh:save-connection,
  // ssh:delete-connection, ssh:test-connection) are already registered by
  // registerSshIpcWindowIndependent() called in Phase A. Do NOT re-register here.
