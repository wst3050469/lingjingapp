...
try {
  ...
  // Fix: Replace ALL top-level require("@codepilot/core/...") with generic safe wrapper.
  {
    ...
    const SAFE_REQUIRE_PREAMBLE = [
      '// @codepilot/core safe-require wrapper (v5: auto-repair on all failures)',
      ...
      '      console.warn("[main] @codepilot/core outdated, attempting auto-repair...");',
      ...
      '      }',
      '      console.warn("[main] " + modulePath + " unavailable at startup, returning stub");',
      '      return {};',
      '    }',
      '    throw e;',
      '  }',
