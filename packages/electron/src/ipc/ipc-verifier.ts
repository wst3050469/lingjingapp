...
const CRITICAL_HANDLERS: string[] = [
  ...
  'cloud:status',
  'cloud:proxy-api',
  'cloud:memories:search',
  // Memory
  'memory:pull-from-cloud',
  // Config
  'config:get',
  'config:set',
  // Update
  ...
  'hw-skill:detect-cli',
  // HW AI Design
  'hw-ai:generate-schematic',
  'hw-ai:suggest-pcb-layout',
  'hw-ai:suggest-drc-fix',
  'hw-ai:select-component',
  'hw-ai:apply-result',
  'hw-ai:rollback-result',
  // Skill Reviews
  'skill:review:upsert',
  'skill:review:list',
  'skill:stats',
...
function generateFeatureDescriptions(missing: string[]): string[] {
  const featureMap: Record<string, string> = {
    ...
    'cloud:memories:search': 'Cloud Memory — cross-device search',
    'memory:pull-from-cloud': 'Cloud Memory — pull & merge from cloud',
    ...
    'bug:list': 'Bug Fix — list bugs',
    'bug:analyze': 'Bug Fix — analyze bugs',
    'bug:fix': 'Bug Fix — apply fix',
    'bug:verify': 'Bug Fix — verify fix',
    'session:checkpoint': 'Session — save checkpoint',
    'session:restore': 'Session — restore from checkpoint',
    'session:list': 'Session — list all sessions',
    'session:list-active': 'Session — list active sessions',
    'session:detect-interruption': 'Session — detect interruption',
    'marketplace:search': 'Marketplace — search skills',
    'marketplace:install': 'Marketplace — install skill',
    'marketplace:uninstall': 'Marketplace — uninstall skill',
    'marketplace:rate': 'Marketplace — rate skill',
    'push:register-device': 'Push — register device',
    'memory:search-cloud': 'Memory — cloud semantic search',
    'memory:pull-cloud': 'Memory — pull cloud memories',
  };
