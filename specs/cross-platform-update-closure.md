...
| 生产: `/var/www/html/latest.yml` | 重新生成静态文件 | #2 |
| 生产: `/var/www/html/latest-linux.yml` | 重新生成静态文件 | #2 |

## 部署计划
1. 修改代码 → git commit
2. 重新生成 latest.yml / latest-linux.yml → 上传到生产
...
5. 更新 versions.json 中 releaseNotes
6. 全端点验证
