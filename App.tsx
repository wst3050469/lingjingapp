// 灵境AI 移动端 - 应用入口 (合并 lingjing-mobile + mobile 全部功能)
  ...
  async function initConnection() {
    ...
    if (persisted?.token) {
      ...
      try {
        ...
        if (me.ok) {
          // BUGFIX: /api/auth/verify 返回 { ok, deviceId, deviceName } 不包含 user
          // 使用 deviceId 或持久化 user 信息
          setAuth(me.deviceId || 'cloud_user', persisted.token);
