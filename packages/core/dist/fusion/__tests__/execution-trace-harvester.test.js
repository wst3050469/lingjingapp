...
describe('ExecutionTraceHarvester', () => {
    ...
    describe('analyzeAndGenerateSkill', () => {
        ...
        it('should publish skill:loaded event on success', async () => {
            ...
            const localHandlers = {};
            const localBus = {
                subscribe: vi.fn((topic, handler) => { localHandlers[topic] = handler; return vi.fn(); }),
                publish: vi.fn(),
                unsubscribe: vi.fn(),
            };
            h.initialize(localBus, mockLLM);
...
//# sourceMappingURL=execution-trace-harvester.test.js.map