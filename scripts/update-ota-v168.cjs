...
const files = {
  'LingJing-Setup-1.73.168-win-x64.exe': 'win-x64_setup',
  'LingJing-Portable-1.73.168-win-x64.exe': 'win-x64_portable',
  'LingJing-1.73.168-linux-x86_64.AppImage': 'linux-x64_appimage',
  'LingJing-1.73.168-linux-x86_64.deb': 'linux-x64_deb',
  'LingJing-Mobile-1.73.168.apk': 'android',
};

const V = '1.73.168';
const epoch = new Date().toISOString();

const versionsEntry = { version: V, releaseDate: epoch, releaseNotes: 'v1.73.168: ChatActionBar - file upload + voice + task stop', files: {} };
...
const setupFile = 'LingJing-Setup-1.73.168-win-x64.exe';
...
const appimageFile = 'LingJing-1.73.168-linux-x86_64.AppImage';
...
const apkFile = 'LingJing-Mobile-1.73.168.apk';
...
const av = {
  ...
  fileSize: apkSize,
  releaseDate: epoch,
  releaseNotes: 'v1.73.168: ChatActionBar - file upload + voice + task stop',
};
