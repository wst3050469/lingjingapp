...
export const useCustomerStore = defineStore('customers', () => {
  ...
  async function loadList(): Promise<void> { loading.value = true; try { const res = await customerApi.list(); if (res.code === 0) list.value = res.data; } finally { loading.value = false; } }
