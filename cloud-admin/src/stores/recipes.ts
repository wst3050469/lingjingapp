...
export const useRecipeStore = defineStore('recipes', () => {
  ...
  async function loadList(): Promise<void> { loading.value = true; try { const res = await recipeApi.list(); if (res.code === 0) list.value = res.data; } finally { loading.value = false; } }
