...
const CLOUD_URL = process.env.LINGJING_CLOUD_URL || 'https://lingjing.zhejiangjinmo.com';
        ...
        try {
            switch (action) {
                case 'search': {
                    ...
                    const results = await cloudFetch(`/memories?action=search&query=${encodeURIComponent(query)}`);
