...
// === 类型重导出（electron 及外部依赖） ===
// 这些类型定义在子模块中但未通过 index 重新导出
export type { LLMProvider, ChatRequest, StreamEvent } from './fusion/adapters/types.js';
export type { AgentEvent } from './agent/agent.js';
export type { AgentConfig } from './agent/agent.js';
export type { Message } from './agent/message-types.js';
export type { AppConfig } from './config/schema.js';
export type { SkillConfig } from './skills/types.js';
// CloudSyncOptions 别名（实际类型为 CloudSyncClientOptions）
export type { CloudSyncClientOptions as CloudSyncOptions } from './cloud/sync-client.js';
