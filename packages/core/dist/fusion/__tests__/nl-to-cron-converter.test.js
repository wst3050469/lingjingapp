...
describe('NLToCronConverter', () => {
    ...
    describe('LLM conversion', () => {
        it('should fallback to rule-based when LLM returns invalid cron', async () => {
            ...
            const result = await converter.convert('every day', mockLLM);
        ...
        it('should use LLM result when valid cron', async () => {
            ...
            const result = await converter.convert('every monday at 9:30', mockLLM);
...
//# sourceMappingURL=nl-to-cron-converter.test.js.map