 ...
 * NOTE: patch-renderer.tsx excluded — imports 'react' crashes Electron main process
 *       (ERR_MODULE_NOT_FOUND). Sidebar panels registered directly in renderer bundle.
 * NOTE: patch-openspace.ts removed — OpenSpace integration extracted to separate module.
 */
