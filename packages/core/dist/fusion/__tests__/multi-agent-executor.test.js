...
describe('MultiAgentExecutor', () => {
    ...
    function makeTask(id, prompt = 'do stuff') {
    ...
    describe('execute', () => {
        ...
        it('should handle task timeout via AbortSignal', async () => {
            executeFn.mockImplementation(async (_task, _ctx, signal) => {
        ...
        it('should degrade to sequential when maxConcurrency is 1', async () => {
            const order = [];
            const tracker = vi.fn().mockImplementation(async (task) => {
...
//# sourceMappingURL=multi-agent-executor.test.js.map