...
export type OpenSpaceEventTopic = 'openspace:started' | 'openspace:stopped' | 'openspace:script_executed' | 'openspace:script_failed' | 'openspace:scene_changed' | 'openspace:scene_loaded' | 'openspace:property_changed' | 'openspace:recording_started' | 'openspace:recording_stopped' | 'openspace:recording_paused' | 'openspace:sync_connected' | 'openspace:sync_disconnected' | 'openspace:sync_failed' | 'openspace:health_changed' | 'openspace:script_generated' | 'openspace:profile_loaded' | 'openspace:dataset_loaded' | 'openspace:dataset_unloaded' | 'openspace:window_changed' | 'openspace:embed_fallback' | 'openspace:skills_available' | 'openspace:skills_unavailable';
