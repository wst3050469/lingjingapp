...
### 最近完成
- **Phase 3 — 品牌自定义（Logo/主题）**: 管理面板品牌覆盖功能（标题、强调色、Logo Emoji），localStorage 持久化，CSS 变量注入
- **Phase 2 — 自定义URL多租户路由**: 登录表单新增服务器地址输入，书签存储URL
- **Phase 1 — 快捷方式收藏夹**: 登录面板新增书签保存/一键登录/管理功能
- **版本升级**: v1.64.11 → v1.64.12，已推送 prod/main
