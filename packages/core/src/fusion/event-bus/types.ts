export type EventTopic =
  | 'agent:message_start' | 'agent:message_end' | 'agent:tool_call' | 'agent:tool_result' | 'agent:compaction'
  | 'memory:updated' | 'memory:window_compacted'
  | 'vector:synced'
  | 'review:completed' | 'review:failed'
  | 'skill:loaded' | 'skill:blocked' | 'skill:executed'
  | 'dag:completed' | 'dag:failed' | 'dag:node_completed'
  | 'parallel:completed'
  | 'model:fallback'
  | 'user_model:updated'
  | 'cron:registered' | 'cron:executed';
