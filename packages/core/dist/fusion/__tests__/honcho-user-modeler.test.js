...
describe('HonchoUserModeler', () => {
    ...
    describe('updateUserModel', () => {
        ...
        it('should publish user_model:updated event', () => {
            modeler.updateUserModel({ codingStyle: ['fp'] });
            expect(eventBus.publish).toHaveBeenCalledWith('user_model:updated', expect.objectContaining({ id: 'user_1' }), 'HonchoUserModeler');
        });
    });
    ...
    describe('persist interval', () => {
        it('should persist on interval tick', () => {
            ...
            expect(memoryAdapter.write).toHaveBeenCalledWith(expect.stringContaining('user_profile:'), expect.objectContaining({ id: 'user_1' }), 'user_profiles');
        });
    });
    describe('destroy', () => {
...
//# sourceMappingURL=honcho-user-modeler.test.js.map