...
f = open(r'D:\lingjing\lingjing\deb_one.txt', 'w', encoding='utf-8')
...
stdin,stdout,stderr = ssh.exec_command('cat /tmp/deb-final.log 2>/dev/null | tail -20')
...
if '1.56.0' in out and 'deb' in out:
    ...
    f.write('Size: ' + deb_size + ' SHA256: ' + deb_sha[:16] + '...\n')
    ...
    ssh3.close()
    f.write('\n=== DEB DEPLOYMENT COMPLETE ===\n')
else:
    f.write('\nDEB still not ready\n')

f.close()

with open(r'D:\lingjing\lingjing\deb_one.txt', 'r', encoding='utf-8') as fr:
    content = fr.read()
with open(r'D:\lingjing\lingjing\deb_one_ascii.txt', 'w', encoding='ascii', errors='replace') as fa:
    fa.write(content)
